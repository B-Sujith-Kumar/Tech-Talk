...
//         });
//         setContent("");
//         setComments((prevComments) => sortComments([...prevComments, comment]));
//       }
//     } catch (error) {
//       toast({
...
//                       currentUser._id?.toString() && (
//                       <CommentOptions comment={comment} user={currentUser} />
//                     )}
//                   </div>
//                 </div>
...
//                     className="mt-4 ml-10 max-sm:ml-0"
//                   >
//                     <div className="flex gap-4 items-start">
//                       <Image
...
//                                     currentUser._id?.toString() && (
//                                     <CommentOptions comment={reply} user={currentUser} />
//                                 )}
//                             </div>
//                           </div>
...
const Comments = async ({
    ...
    return (
        <div>
            ...
            <AddComment post={post} currentUser={curUser} />
            <ViewComments comments={post.comments} post={post} currentUser={curUser} />
        </div>
    );
};
