                ...
                <DialogContent className="max-w-3xl max-md:max-w-2xl max-sm:max-w-[90%] max-md:rounded-lg">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-gray-600">
                            ...
                            {slide === 2 && (
                                <p>
                                    Adding visual flair will catch new members attention and
                                    help establish your community&apos;s culture! You can update this
                                    at any time.
                                </p>
                            )}
                            {slide === 3 && (
                                <p>
                                    Add atleast one tag to help interested tech talkers find
                                    your community.
                                </p>
                            )}
                        </DialogDescription>
                                ...
                                >
                                    ...
                                    <span className="rounded-full bg-gray-300 text-sm gap-2 px-3 flex items-center">
                                        ...
                                        <UploadButton
                                            ...
                                            appearance={{
                                                button:
                                                    "rounded-full py-0 mt-1 bg-gray-300 text-black",
                                            }}
                                            content={{
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex justify-center mb-4">
                            {dots.map((dot) => (
                                <div
                                    key={dot}
                                    className={`h-2 w-2 rounded-full mx-1 ${dot === slide ? "bg-indigo-700" : "bg-gray-400"
                                        }`}
                                />
                            ))}
                        </div>
