        ...
        <div className="h-full">
            ...
            <div className="relative -mt-10 z-10 max-lg:px-2">
                <div className="bg-white max-w-5xl shadow-md mx-auto border border-b-0 rounded-lg relative">
                    ...
                    <div
                        className={`pb-6 ${user.education || user.work ? "border-b-[1px]" : ""
                            }`}
                    >
                        <p
                            className={`text-2xl font-semibold ${user._id?.toString() !== currentUser._id?.toString()
                                ? "mt-5"
                                : "mt-16"
                                    ...
                                    {posts.map((post: IPostPopulated) => (
                                        <>
                                            <FeedPost
                                                post={post}
                                                showBanner={false}
                                                communitiesData={communitiesData.status ? communitiesData.data : []}
                                                currentUser={currentUser}
                                                key={Math.random()}
                                            />
                                        </>
