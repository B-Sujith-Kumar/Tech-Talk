...
import CommunityNotification from "@/components/shared/Community/CommunityNotification";
...
const Page = async ({ params, searchParams }: SearchParamProps) => {
  ...
  const notificationState = community.communityNotification.includes(userObjectId)
        ...
        <div className="flex items-end justify-between relative sm:bottom-6 sm:px-4 flex-wrap max-sm:gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {isMember && (
                <CommunityNotification notificationState={notificationState} user={user} community={community}/>
              )}
              <JoinCommunity
                isMember={isMember}
      ...
      <div className="flex gap-3">
        <div className="xl:w-[70%] max-md:mt-4">
          ...
          {posts
            ...
            .map(
              (post: any) =>
                !community.needsReview.includes(post._id) && (
                  <FeedPost
                    key={post._id}
                    post={post}
                    showBanner={true}
